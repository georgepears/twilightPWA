...
export declare const OFFLINE_ROUTE_OFFLINE: InjectionToken<string>;
export declare const OFFLINE_ROUTE_UNAVAILABLE: InjectionToken<string>;
export declare const OFFLINE_GUARDS_REDIRECT: InjectionToken<boolean>;
...
export declare function offlineProviders(config: OfflineProvidersConfig): Provider[];
